...
while running:
    ...
    # 3. Rectangle d'alerte collision
    if dist < COLLISION_DISTANCE:
        ...
        alert_rect = pygame.Rect(0, 0, radius_px, radius_px)
        alert_rect.center = (alert_px_x, alert_px_y)
        pygame.draw.rect(screen, (255, 80, 80), alert_rect, width=2)
